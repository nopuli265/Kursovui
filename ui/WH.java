...
public class WH extends JFrame {
	...
	public void panelTabHome() {
		...
		jlabImage.setIcon(new ImageIcon("C:\\Users\\nopud\\Desktop\\isometric-warehouse.gif"));
	...
	private void panelTabAdminCheckProduct() {
		...
		jlabCheckN.setBounds(22, 28, 46, 14);
	...
	public void panelTabAdminImport() {
		...
		txtMFG.setBounds(379, 182, 198, 20);
		pnAdd.add(txtMFG);
		...
		txtEXP.setBounds(379, 148, 198, 20);
		pnAdd.add(txtEXP);
	...
	public void panelTabClient() {
		...
		ImageIcon myIcon= new ImageIcon(new ImageIcon("C:\\Users\\nopud\\Desktop\\thank.jpg").getImage().getScaledInstance(800, 300, Image.SCALE_DEFAULT));
